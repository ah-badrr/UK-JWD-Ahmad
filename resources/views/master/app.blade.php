            ...
            <nav id="sidebar">
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li><a href="{{ route('jurusan.index') }}"><i class="fa fa-book white_color"></i>
                                <span>Jurusan</span></a>
                        </li>
                        <li><a href="{{ route('peserta.index') }}"><i class="fa fa-person white_color"></i>
                                <span>Peserta</span></a>
                        </li>
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                                ...
                                                this.closest('form').submit();"><i class="fa fa-sign-out white_color"></i>
                                <span>Log Out</span></a>
                                                </form>
                        </li>
                    </ul>
