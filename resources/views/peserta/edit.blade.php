...
@endsection
@section('header')
    <h2 style="width: max-content">Edit Data Peserta</h2>
@endsection
@section('konten')
    <div class="row">
        <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
                ...
                <form class="padding_infor_info row" action="{{ route('peserta.update', $peserta->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="tempat" type="text" class="form-control @error('tempat') is-invalid @enderror"
                                value="{{ $peserta->tempat_lahir }}" name="tempat">
                            @error('tempat')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                value="{{ $peserta->tanggal_lahir }}" name="tanggal">
                            @error('tanggal')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror"
                                value="{{ $peserta->alamat }}" name="alamat">
                            @error('alamat')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="telepon" type="number" class="form-control @error('telepon') is-invalid @enderror"
                                value="{{ $peserta->telepon }}" name="telepon">
                            @error('telepon')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                value="{{ $peserta->email }}" name="email">
                            @error('email')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="password" type="password"
                                class="form-control @error('password') is-invalid @enderror" value="{{ $peserta->password }}"
                                name="password">
                            @error('password')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="jurusan" id="jurusan"
                                ...
                                <option value="" hidden disabled>Pilih jurusan</option>
                                @foreach ($jurusan as $j)
                                    <option value="{{ $j->id }}" {{ $peserta->jurusan_id == $j->id ? 'selected' : '' }}>
                                        {{ $j->nama }}
                                    </option>
                                @endforeach
                            </select>
