...
@endsection
@section('header')
    <h2 style="width: max-content">Tambah Data Jurusan</h2>
@endsection
@section('konten')
    <div class="row">
        <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
                ...
                <form class="padding_infor_info row" action="{{ route('jurusan.store') }}" method="POST"
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" cols="30" rows="10" id="deskripsi"
                                class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
